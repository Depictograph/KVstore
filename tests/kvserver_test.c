...
test_info_t kvserver_tests[] = {
  ...
  {"GET request succeeds for a key not in the cache but in the store.", kvserver_get_from_store},
  {"PUT request goes write-through our system (ba-dum-tiss)", kvserver_write_through},
  NULL_TEST_INFO
};
