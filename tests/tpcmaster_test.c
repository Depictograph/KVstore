...
test_info_t tpcmaster_tests[] = {
  ...
  {"Register the same slave twice", tpcmaster_register_slave_twice},
  {"Master PUT updates cache", tpcmaster_put_updates_cache},
  {"Master DEL updates cache", tpcmaster_del_updates_cache},
  NULL_TEST_INFO
};
